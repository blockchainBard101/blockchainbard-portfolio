...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "card": "0 1px 0 0 hsla(0,0%,100%,0.05) inset, 0 1px 2px 0 rgba(0,0,0,0.08)",
        "card-dark": "0 1px 0 0 hsla(0,0%,0%,0.2) inset, 0 1px 2px 0 rgba(0,0,0,0.3)",
        "elevated": "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)",
        "elevated-lg": "0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)",
      },
      dropShadow: {
        "glow": "0 0 20px rgba(59, 130, 246, 0.15)",
        "glow-teal": "0 0 20px rgba(0, 231, 212, 0.15)",
      },
      animation: {
